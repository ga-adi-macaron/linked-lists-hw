...
public class Driver {
	...
	public static void main(String[] args) {
		...
		int x = 0;
		while (x<19 && !studentArrayList.get(x).getLastName().equalsIgnoreCase("smith")){
			x++;
		}
		...
		double gpa = studentArrayList.get(2).getGpa();
		studentArrayList.set(2,new Student("Joe", "Montana",gpa));
